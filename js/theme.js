...
// Because you're technically focused on a checkbox, but visually it looks like a link
// we make it act like you clicked it on enter, even though checkboxes are clicked on space
document.querySelector('#toggle-darkmode').addEventListener('keypress', (e) => {
  if (event.which === 13) {
